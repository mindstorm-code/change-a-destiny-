    ...
    <main>
      <section className="border-b border-hairline">
        <div className="mx-auto max-w-3xl px-6 pt-24 pb-16 text-center sm:pt-28">
          ...
          <h1 className="font-serif-display text-4xl leading-tight text-cream text-balance sm:text-5xl">
              ...
              return (
                ...
                >
                  <div className="flex shrink-0 flex-col items-center gap-2">
                    <span className="font-serif-display text-xl text-muted/50">{m.n}</span>
                  ...
                  <div>
                    ...
                    <h3 className="mt-1.5 font-serif-display text-lg text-cream">{m.title}</h3>
      ...
      <section className="border-b border-hairline">
        <div className="mx-auto max-w-3xl px-6 py-20">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            <div>
              <p className="font-serif-display text-lg text-cream">15–20 min videos</p>
              <p className="mt-2 text-sm leading-relaxed text-muted">
                Short enough to finish one module per sitting.
              </p>
            </div>
            <div>
              <p className="font-serif-display text-lg text-cream">A printable workbook</p>
              <p className="mt-2 text-sm leading-relaxed text-muted">
                One worksheet per module, extending the book you already have.
              </p>
            </div>
            <div>
              <p className="font-serif-display text-lg text-cream">One live call a week</p>
              <p className="mt-2 text-sm leading-relaxed text-muted">
